...
# Variables
global k_rho, k_alpha, state, substate, goal_set, distance, angle, goal, vel, vel_maxlin, vel_maxang, pose_received
k_rho = 0.3
k_alpha = 0.8
state = "STOP"
substate = "STOP"
...
def poseCB(p):
  global goal_set, distance, angle, goal, pose_received
  pose_received = True
  if goal_set:
