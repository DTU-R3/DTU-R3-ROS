...
# Variables
global k_rho, k_alpha, robot_state, goal_set, distance, angle, goal, vel, vel_maxlin, vel_maxang, robot_x, robot_y, robot_th
k_rho = 0.3
k_alpha = 0.8
robot_state = "IDLE"
goal_set = False
...
def odomCB(odo):
  global goal_set, distance, angle, goal, robot_x, robot_y, robot_th
  robot_x = odo.pose.pose.position.x
  robot_y = odo.pose.pose.position.y
  robot_th = 2.0 * math.atan2(odo.pose.pose.orientation.z,odo.pose.pose.orientation.w)
  if goal_set:
